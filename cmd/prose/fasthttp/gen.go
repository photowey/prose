...
import (
	...
	"github.com/photowey/prose/cmd/prose/fasthttp/register"
...
var gen = &cobra.Command{
	Use:   "gen",
	Short: "Generate fasthttp router register codes.",
	Long:  "Generate fasthttp router register codes.",
	Example: `Generate fasthttp router register codes.,
